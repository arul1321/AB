...
audio35 = fs.readFileSync('./X4/nyz35.m4a') 
			...
			case 'sticker':  
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUBSCRIBE YT AkbarbarzZ')
            ...
            .toFormat('webp')
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUBSCRIBE YT Akbarbarz')
         	nayla.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: nay1})
         	fs.unlinkSync(media)
         	fs.unlinkSync(ran)
         	})
